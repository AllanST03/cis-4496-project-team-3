...
window.config(background="#2d292d")
# Icon + title image
ICON_PATH = r"C:\Users\allan\Desktop\TU\Spring 2026\Projects of Data Science\Project\Helix.png"   # This shoul changed based on the system, this is only for me
...
style.configure("TFrame", background="#2d292d")

style.configure("TLabel", background="#2d292d", foreground="white", font=("Arial", 12)) # input labels
style.configure("Header.TLabel", background="#2d292d", foreground="white", font=("Impact", 13, "bold")) #???
...
style.configure("TRadiobutton", background="#2d292d", foreground="white") # for the this or that options
...
# Tumor Size (Entry)
ttk.Label(form, text="Tumor size (number):").grid(row=current_row, column=0, sticky="w", pady=6)
...
# Dosage (Entry)
ttk.Label(form, text="Dosage (number):").grid(row=current_row, column=0, sticky="w", pady=6)
